...
# ===================================================================
# Dengan mendefinisikannya di sini, variabel ini bisa diakses oleh SEMUA kelas di bawahnya.
# Kita beri nama umum karena akan dipakai di kedua form.
...
class RegistrationForm(forms.ModelForm):
    # Sekarang kita langsung gunakan variabel FORM_INPUT_CLASS yang sudah didefinisikan di atas
